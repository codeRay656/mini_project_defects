...
def main():
    ...
    if st.button("Predict Defect Type"):
        ...
        st.success(f"🛠 Predicted Defect Type: **{defect_type}**")
...
mlflow.set_experiment("Defect_Type_Classification")
...
# Save local backup
model.save("mlp_model.h5")   # HDF5 format backup
...
mlflow.log_artifact("mlp_model.h5")
